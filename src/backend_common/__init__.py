...
def create_app(
    ...
    **kw,
    ...
    for extension_name in EXTENSIONS:
        ...
        try:
            extension_init_app = getattr(
                importlib.import_module("backend_common." + extension_name), "init_app"
            )
    ...
    if enable_dockerflow:
        ...
        app.add_url_rule(
            "/__lbheartbeat__", view_func=backend_common.dockerflow.lbheartbeat_response
        )
